        ...
        <div>
          ...
          {!user.totpEnabled ? (
            <div className="mt-3 space-y-3">
              {totpSetup ? (
              <>
                <div className="space-y-3 rounded border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 p-4">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div className="rounded bg-gray-100 dark:bg-gray-800 px-2 py-1 font-mono text-sm break-all flex-1">
                      {totpSetup.secret}
                    </div>
                    <Button
                      size="small"
